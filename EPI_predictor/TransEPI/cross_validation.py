...
def get_args():
    ...
    p.add_argument('--train_EPI', required=True, help="EPI data for training")
    p.add_argument('--test_EPI', required=True, help="EPI data for testing")
    p.add_argument('--train_cell', required=True)
...
if __name__ == "__main__":
    ...
    if args.train_mode:
        ...
        train(
            ...
            add_dist_loss=args.use_dist_loss,
