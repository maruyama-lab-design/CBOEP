...
if __name__ == "__main__":
    infile = os.path.join(os.path.dirname(__file__), "..", "input_to_neg_generator", "unnormalized_BENGI", "GM12878.csv")
    outfile = os.path.join(os.path.dirname(__file__), "..", "input_to_neg_generator", "normalized_BENGI", "test-GM12878.csv")
