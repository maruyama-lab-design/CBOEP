...
def add_features_to_trainingData(args):
	...
	pairs_df = pd.read_csv(args.filename)
	...
	training_df.to_csv(args.filename, index=False)
...
if __name__ == '__main__':
	...
	for cell_line in ["NHEK", "IMR90", "HUVEC"]:
		for dataset in ["TargetFinder", "EP2vec", "new"]:
			args.cell_line = cell_line
			args.dataset = dataset
			args.filename = f"/Users/ylwrvr/卒論/Koga_code/compare_model/training_data/{args.dataset}/{args.cell_line}_train.csv"

			args.cage_root = f"/Users/ylwrvr/卒論/Koga_code/compare_model/TargetFinder/features/{args.cell_line}/cage"
			args.peak_root = f"/Users/ylwrvr/卒論/Koga_code/compare_model/TargetFinder/features/{args.cell_line}/peaks"
			args.methylation_root = f"/Users/ylwrvr/卒論/Koga_code/compare_model/TargetFinder/features/{args.cell_line}/methylation"

			args.output_dir = f"/Users/ylwrvr/卒論/Koga_code/compare_model/result/TargetFinder/{args.cell_line}/{args.dataset}"
