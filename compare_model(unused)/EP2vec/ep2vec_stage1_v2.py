...
def ep2vec_stage1_v2(args):
	...
	input_dir = os.path.join(os.path.dirname(__file__), "preprocess", args.cell_line, args.way_of_kmer)
	input_path = ""
	k_set = args.k_set.split(",")
	print(k_set)
	input_path_list = []
	for k in k_set:
	...
	output_path = os.path.join(output_dir, f"{args.k_set}_{args.stride}.d2v")
	if args.epochs != 10:
		output_path = os.path.join(output_dir, f"{args.k_set}_{args.stride}_{args.epochs}.d2v")
